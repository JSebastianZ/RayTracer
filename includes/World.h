...
namespace rtc {
	...
	/*
	* The Ray Tracer renders all the objects defined in this class.
	*/
	...
	public:
		...
		// Definition of objects materials.
		...
		// Point used as scaling factor.
		Point p1 = Point(10, 0.01, 10);

		// Definition of each world object transform matrix.
		// Necessary for every object, at least translate matrix to origin.
		...
		// 3D scene is created as a World object.
		// Light sources and objects are constructed.
		// Objects are stored in an objects collection data structure for reference.
		World() {
